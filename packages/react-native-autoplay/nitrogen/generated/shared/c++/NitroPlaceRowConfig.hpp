...
namespace margelo::nitro::swe::iternio::reactnativeautoplay {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NitroPlaceRowConfig).
   */
  struct NitroPlaceRowConfig final {
  public:
    ...
    std::optional<NitroAutoPlace> place     SWIFT_PRIVATE;
    std::optional<std::function<void()>> onPress     SWIFT_PRIVATE;

  public:
    NitroPlaceRowConfig() = default;
    explicit NitroPlaceRowConfig(AutoText title, std::optional<AutoText> detailedText, std::optional<bool> browsable, bool enabled, std::optional<std::variant<GlyphImage, AssetImage, RemoteImage>> image, std::optional<NitroAutoPlace> place, std::optional<std::function<void()>> onPress): title(title), detailedText(detailedText), browsable(browsable), enabled(enabled), image(image), place(place), onPress(onPress) {}

  public:
    // NitroPlaceRowConfig is not equatable because these properties are not equatable: onPress
  };
...
namespace margelo::nitro {
  ...
  // C++ NitroPlaceRowConfig <> JS NitroPlaceRowConfig (object)
  template <>
  struct JSIConverter<margelo::nitro::swe::iternio::reactnativeautoplay::NitroPlaceRowConfig> final {
    static inline margelo::nitro::swe::iternio::reactnativeautoplay::NitroPlaceRowConfig fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::swe::iternio::reactnativeautoplay::NitroPlaceRowConfig(
        ...
        JSIConverter<std::optional<margelo::nitro::swe::iternio::reactnativeautoplay::NitroAutoPlace>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "place"))),
        JSIConverter<std::optional<std::function<void()>>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "onPress")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::swe::iternio::reactnativeautoplay::NitroPlaceRowConfig& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "place"), JSIConverter<std::optional<margelo::nitro::swe::iternio::reactnativeautoplay::NitroAutoPlace>>::toJSI(runtime, arg.place));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<margelo::nitro::swe::iternio::reactnativeautoplay::NitroAutoPlace>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "place")))) return false;
