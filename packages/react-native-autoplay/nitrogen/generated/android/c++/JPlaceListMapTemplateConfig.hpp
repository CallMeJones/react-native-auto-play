///
/// JPlaceListMapTemplateConfig.hpp
...
namespace margelo::nitro::swe::iternio::reactnativeautoplay {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "PlaceListMapTemplateConfig" and the the Kotlin data class "PlaceListMapTemplateConfig".
   */
  struct JPlaceListMapTemplateConfig final: public jni::JavaClass<JPlaceListMapTemplateConfig> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/swe/iternio/reactnativeautoplay/PlaceListMapTemplateConfig;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct PlaceListMapTemplateConfig by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    PlaceListMapTemplateConfig toCpp() const {
      ...
      static const auto fieldRows = clazz->getField<jni::JArrayClass<JNitroPlaceRowConfig>>("rows");
      jni::local_ref<jni::JArrayClass<JNitroPlaceRowConfig>> rows = this->getFieldValue(fieldRows);
      return PlaceListMapTemplateConfig(
        id->toStdString(),
        ...
        [&](auto&& __input) {
          size_t __size = __input->size();
          std::vector<NitroPlaceRowConfig> __vector;
          __vector.reserve(__size);
          for (size_t __i = 0; __i < __size; __i++) {
            auto __element = __input->getElement(__i);
            __vector.push_back(__element->toCpp());
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JPlaceListMapTemplateConfig::javaobject> fromCpp(const PlaceListMapTemplateConfig& value) {
      using JSignature = JPlaceListMapTemplateConfig(jni::alias_ref<jni::JString>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void_std__optional_bool_::javaobject>, jni::alias_ref<JFunc_void::javaobject>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JArrayClass<JNitroAction>>, jni::alias_ref<JAutoText>, jni::alias_ref<jni::JArrayClass<JNitroPlaceRowConfig>>);
      static const auto clazz = javaClassStatic();
