...
export declare enum OffRampType {
...
export declare enum OnRampType {
...
export interface WaypointManeuver extends BaseManeuver {
    maneuverType: ManeuverType.Arrive | ManeuverType.ArriveLeft | ManeuverType.ArriveRight | ManeuverType.Depart;
}
...
export type Maneuver = WaypointManeuver | StraightManeuver | TurnManeuver | RoundaboutManeuver | OffRampManeuver | OnRampManeuver | FerryManeuver | ForkManeuver | KeepManeuver;
export type AttributedInstructionVariantImage = {
    image: ManeuverImage;
    position: number;
};
