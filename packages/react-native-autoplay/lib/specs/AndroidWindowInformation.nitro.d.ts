 ...
 */
export interface AndroidWindowInformation extends HybridObject<{
    android: 'kotlin';
}> {
    /**
     ...
     * @namespace Android
     */
    addWindowInformationListener(moduleName: string, callback: (window: WindowInformation) => void): CleanupCallback;
}
